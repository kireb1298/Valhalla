...
|--------------------------------------------------------------------------
*/
$config['server_name'] = "Valhalla Server";
...
|--------------------------------------------------------------------------
*/
$config['realmlist'] = "valhallawow.tk";
...
|
*/
$config['keywords'] = "World of Warcraft, World of Warcraft 3.3.5, WoW, Legion, World of Warcraft Wrath of the Lich king, Lich King, Lich King 3.3.5, wow pelicula, wow custom. wow anime, sword art online, mmorpg, el mejor mmorpg, juegos rol";
$config['description'] = "El mejor servidor de World of Warcraft con la expansión Wrath of the Lich King en Español.";
