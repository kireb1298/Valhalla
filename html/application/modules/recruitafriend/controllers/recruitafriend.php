...
class Recruitafriend extends MX_Controller
{
	...
	{
		$this->template->setTitle("Reclutar a un Amigo");
		...
		$this->template->view($this->template->loadPage("page.tpl", array(
			"module" => "default", 
			"headline" => "<span style='cursor:pointer;' onClick='window.location=\"".$this->template->page_url."ucp\"'>UCP</span> &rarr; Reclutar",
