...
<section id="armory_mid_info">
    ...
    <div class="recent-activity">
        ...
        {else}
        	<li id="no-records">No hay registro de Logros.</li>
        {/if}
        </ul>
    </div>
    
	<div class="professions">
    	<h3>Profesiones Principales</h3>
		<ul>
        	{foreach from=$main_professions key=key item=prof}
                ...
                {else}
                	<li class="profession profession-empty">No hay profesion</li>
                {/if}
            {/foreach}
        </ul>
        {if $secondary_professions}
            <h3>Profesiones Secundarias</h3>
            <ul>
...
<section id="armory_title" style="margin-top: 10px;">
    <div><h3>Equipo de Arenas</h3></div>
</section>
