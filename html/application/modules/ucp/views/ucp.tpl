	...
	<section id="ucp_info">
		<aside>
			<table width="100%">
				...
				<tr>
					<td width="5%"><img src="{$url}application/images/icons/plugin.png" /></td>
				...
				<tr>
					...
					<td width="50%">{lang("account_rank", "ucp")}</td>
		...
		<aside>
			<table width="100%">
				<tr data-tip="Earn voting points by voting for the server">
					...
					<td width="50%">{lang("voting_points", "ucp")}</td>
					<td width="50%">{$vp}</td>
				</tr>
				<tr data-tip="Earn donation points by donating money to the server">
					...
					<td width="50%">{lang("donation_points", "ucp")}</td>
					<td width="50%">{$dp}</td>
				</tr>
				<tr>
					<td width="5%"><img src="{$url}application/images/icons/shield.png" /></td>
					<td width="50%">{lang("account_status", "ucp")}</td>
					<td width="50%">{$status}</td>
				</tr>
				<tr>
					<td width="5%"><img src="{$url}application/images/icons/date.png" /></td>
					<td width="50%">{lang("member_since", "ucp")}</td>
