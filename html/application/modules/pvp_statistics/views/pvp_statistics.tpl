	...
	<section id="statistics">
        ...
        {if $realms_count > 0}
        	...
        	<section id="statistics_title" style="margin-top: 10px;">
            	<div style=""><h3>Top Equipos de Arena</h3></div>
            </section>
        	...
        	<section id="statistics_title" style="margin-top: 40px; margin-bottom: 10px;">
            	<div><h3>Top Asesinos con Honor</h3></div>
            </section>
        	...
        	<section class="statistics_top_hk" style="display:block;">
                ...
                <table class="nice_table" cellspacing="0" cellpadding="0">
                    <tr>
                    	...
                    	<td width="15%" align="center">Asesinatos</td>
                        <td width="30%" align="center">Jugador</td>
                    ...
                    {if $TopHK}
                  	...
                  	{else}
                    	<tr>
                        	<td colspan="5"><center>No hay jugadores con asesinatos con honor</center></td>
                      	</tr>
                	{/if}
                </table>
