...
class Register extends MX_Controller
{
	...
	{
		$this->template->setTitle("Registro");
			...
			|| !$emailAvailable)
		{
			...
			if($this->input->post("r") && $this->external_account_model->userExists($this->input->post("r")) == false)
			{
				...
				"module" => "default", 
				"headline" => "Creacion de Cuenta",
				"content" => "Error : La cuenta del reclutador no existe, porfavor registrese utilizando el siguiente link: <a href=\"register\">register</a>"
			)), false, "modules/register/js/validate.js", "Creacion de cuenta");
