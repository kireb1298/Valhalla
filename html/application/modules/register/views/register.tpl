{form_open('register', 'class="page_form"')}
	<table style="width:80%">
		<tr>
			<td><label for="register_username">Usuario</label></td>
			<td>
		...
		<tr>
			<td><label for="register_password">Contraseña</label></td>
			<td>
		...
		<tr>
			<td><label for="register_password_confirm">Confirm Contraseña</label></td>
			<td>
	...
	<center style="margin-bottom:10px;">
		<input type="submit" name="login_submit" value="Crear Cuenta" />
	</center>
{form_close()}